...
void Date::setDate(int mm, int dd, int yy)
{
    ...
    if ((month == 2 && leapYear(year) && dd >= 1 && dd <= 29) ||
        (dd >= 1 && dd <= days[month]))
        day = dd;
    else throw invalid_argument("Day is out of range of current month and year");
...
// note that the dummy integer parameter does not hava a parameter name
